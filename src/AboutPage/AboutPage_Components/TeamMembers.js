...
export default function TeamMembers(props) {
  const teamMemberArray = [
    ...
    },
    {
      ...
      illustrationer: "Har illustreret Superhelteøen",
      text: " ",
    ...
    },
    {
      ...
      illustrationer: "Har illustreret Monsterøen",
      text: "",
    },
    {
      type: "member",
      ...
      title: "Illustrator og Animator",
      illustrationer: "Har illustreret Eventyrøen",
      text: "",
    },
  ];
    ...
    if (props.type == member.type) {
      return (
        <li className="TeamMember">
          ...
          <h3>{member.title}</h3>
          <h3 className="illustrationer">{member.illustrationer}</h3>
          {/* <p>{member.text}</p> */}
        </li>
      );
    }
