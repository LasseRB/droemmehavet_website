  ...
  <div class="blog">
    <article>
      <div class="hero">
        ...
        <h1>Betatest sommer 2025</h1>
        <h3>11. August</h3>
        </div>
        <div class="hero-image">
          <img src="~/assets/piratskibet_saeler.png">
        </div>
      </div>
      <section class="broedtekst">
        ...
        <p>Vi har ikke sat en slutdato for testfasen. Indtil videre lader vi den køre så længe, det giver mening at modtage feedback. Vi skal nok skrive når vi mener, vi er klar til næste fase af udgivelsen.</p>
